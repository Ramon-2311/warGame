...
func _physics_process(delta):
	velocidade.x = Input.get_action_strength("direitaP2") - Input.get_action_strength("esquerdaP2")
	velocidade.y = Input.get_action_strength("baixoP2") - Input.get_action_strength("cimaP2")
